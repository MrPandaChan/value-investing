...
const stocks: StockItem[] = [
  ...
  },
  {
    ...
    dividendPerYear: 2,
    remark: "中报业绩预增，今年业绩不错，买入和退出条件放宽",
    maxPositionRatio: 0.05,
    plan: {
      type: PlanType.DIVIDEND,
      dividend: [
  ...
  },
  {
    ...
    plan: {
      type: PlanType.DIVIDEND,
      dividend: [{ value: 0.08, quantity: 200 }],
    },
    exit: {
      type: PlanType.DIVIDEND,
  ...
  },
  {
    ...
    plan: {
      type: PlanType.PRICE,
      price: [{ value: 0.9, quantity: 3000 }],
    },
    exit: {
      type: PlanType.PRICE,
      price: [{ value: 1.4, quantity: 100 }],
    },
    strikePrice: {
      type: PlanType.PRICE,
      value: 1,
